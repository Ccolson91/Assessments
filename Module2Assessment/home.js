...
const checkZipCode = canWeDeliver(85205)
...
//CODE HERE
const newDealTitle = deals[0].title.replace('15% Off', '10% Off')
console.log(newDealTitle)
...
const kidDealUpdate = deals[1].desc.replace('March', 'April').trim()
console.log(kidDealUpdate)
